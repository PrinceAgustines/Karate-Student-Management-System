...
class TensorFlowFaceEncoder:
    ...
    def preprocess_face(self, image: ndarray, face_location: Tuple[int, int, int, int]) -> ndarray:
    ...
    def encode(self, image: ndarray, face_location: Tuple[int, int, int, int]) -> Optional[ndarray]:
